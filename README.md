...
└── service/
    ...
    └── src/
        ...
        │   └── webui/               # Angular frontend (managed by Quinoa)
        │       ├── package.json
        │       ├── angular.json
        │       └── src/             # Angular source
        └── test/
...
The Angular UI is located at `service/src/main/webui/`. It is built and served via [Quarkus Quinoa](https://quarkiverse.github.io/quarkiverse-docs/quarkus-quinoa/dev/index.html) during development and packaged into the application at build time.
