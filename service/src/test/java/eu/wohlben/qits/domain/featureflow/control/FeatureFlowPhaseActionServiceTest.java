...
public class FeatureFlowPhaseActionServiceTest {
    ...
    public void testCreateMissingStepThrows() {
        ...
        assertThrows(BadRequestException.class, () ->
            featureFlowPhaseActionService.create(null, action.id, ActionType.PREREQUISITE, 0, null)
        );
    }
    ...
    public void testCreateUnknownStepThrows() {
        ...
        assertThrows(NotFoundException.class, () ->
            featureFlowPhaseActionService.create("non-existent", action.id, ActionType.PREREQUISITE, 0, null)
        );
    }
    ...
    public void testCreateUnknownActionThrows() {
        var step = createStep();
        assertThrows(NotFoundException.class, () ->
            featureFlowPhaseActionService.create(step.id, "non-existent", ActionType.PREREQUISITE, 0, null)
        );
    }
    ...
    public void testGetNotFoundThrows() {
        assertThrows(NotFoundException.class, () ->
            featureFlowPhaseActionService.get("non-existent")
        );
    }
    ...
    public void testUpdate() {
        ...
        var updated = featureFlowPhaseActionService.update(
            link.id, ActionType.QUALITY_GATE, 5, "new-group"
        );
    ...
    public void testDeleteNotFoundThrows() {
        assertThrows(NotFoundException.class, () ->
            featureFlowPhaseActionService.delete("non-existent")
        );
    }
}
