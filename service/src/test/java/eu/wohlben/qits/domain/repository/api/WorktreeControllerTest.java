...
public class WorktreeControllerTest {
    ...
    public void testListWorktreesReturnsCreatedWorktreeWithBranch() {
        ...
        .then()
            ...
            .body("entries.find { it.worktree.worktreeId == 'wt-list' }.worktree.branch", equalTo("wt-branch"));
    }
    ...
    public void testTwoWorktreesCanForkFromTheSameParentBranch() {
        ...
        .then()
            .statusCode(Response.Status.OK.getStatusCode())
            .body("entries.find { it.worktree.worktreeId == 'fork-a' }.worktree.branch", equalTo("branch-a"))
            .body("entries.find { it.worktree.worktreeId == 'fork-b' }.worktree.branch", equalTo("branch-b"));
    }
