...
public class FeatureFlowPhaseActionControllerTest {
    ...
    public void testCreateAndGetAndListAndUpdateAndDelete() {
        ...
        String linkId = given()
            ...
            .body(new FeatureFlowPhaseActionController.CreateFeatureFlowPhaseActionRequest(
        ...
        given()
            .contentType(ContentType.JSON)
            .body(new FeatureFlowPhaseActionController.UpdateFeatureFlowPhaseActionRequest(
