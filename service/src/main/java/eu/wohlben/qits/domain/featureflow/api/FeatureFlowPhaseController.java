...
public class FeatureFlowPhaseController {
  ...
  @POST
  public CreateFeatureFlowPhaseRequest.Response create(
      @Valid CreateFeatureFlowPhaseRequest request) {
    var phase =
    ...
    return new CreateFeatureFlowPhaseRequest.Response(featureFlowPhaseMapper.toDto(phase));
  }
  ...
  public GetFeatureFlowPhaseRequest.Response get(@PathParam("id") String id) {
    ...
    return new GetFeatureFlowPhaseRequest.Response(featureFlowPhaseMapper.toDto(phase));
  }
  ...
  @GET
  public ListFeatureFlowPhasesRequest.Response list(
      @QueryParam("featureFlowConfigurationId") String featureFlowConfigurationId) {
    List<FeatureFlowPhase> phases =
        featureFlowConfigurationId != null
    ...
    var entries =
        phases.stream()
            .map(
                p ->
                    new ListFeatureFlowPhasesRequest.Response.Entry(
  ...
  @PUT
  @Path("/{id}")
  public UpdateFeatureFlowPhaseRequest.Response update(
      @PathParam("id") String id, @Valid UpdateFeatureFlowPhaseRequest request) {
    var phase =
        featureFlowPhaseService.update(
            id,
            request.name(),
            request.description(),
            request.orderIndex(),
            request.parentPhaseId());
    return new UpdateFeatureFlowPhaseRequest.Response(featureFlowPhaseMapper.toDto(phase));
  }
