...
public class ActionConfigurationController {
  ...
  @POST
  public CreateActionConfigurationRequest.Response create(
  ...
  public GetActionConfigurationRequest.Response get(@PathParam("id") String id) {
    ...
    return new GetActionConfigurationRequest.Response(actionConfigurationMapper.toDto(config));
  }
  ...
  public ListActionConfigurationsRequest.Response list() {
    ...
    var entries =
        configs.stream()
            .map(
                c ->
                    new ListActionConfigurationsRequest.Response.Entry(
  ...
  @PUT
  @Path("/{id}")
  public UpdateActionConfigurationRequest.Response update(
      @PathParam("id") String id, @Valid UpdateActionConfigurationRequest request) {
    var config =
