...
You can run your application in dev mode that enables live coding. Run from the **repo root** so the
`domain` module is built and reactor-aware (live-reloads too):
