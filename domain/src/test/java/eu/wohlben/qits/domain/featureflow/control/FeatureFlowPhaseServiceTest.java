...
public class FeatureFlowPhaseServiceTest {
  ...
  public void testGetNotFoundThrows() {
    assertThrows(NotFoundException.class, () -> featureFlowPhaseService.get("non-existent"));
  }
  ...
  public void testDeleteNotFoundThrows() {
    assertThrows(NotFoundException.class, () -> featureFlowPhaseService.delete("non-existent"));
  }
}
