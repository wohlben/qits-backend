...
/**
 * The contents of a single file in a worktree's working tree, for the file browser.
 *
 ...
 *     placeholder
 */
public record WorktreeFileContentDto(String path, String content, boolean binary) {}
