 ...
 * {@link #SERVICE} is a supervised long-running PTY process (dev server, watcher) whose lifecycle
 * is owned by the {@code ServiceSupervisor} — attachable like a terminal, but restarts spawn a new
