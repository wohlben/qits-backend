 ...
 * in a worktree checkout and returns its combined output and exit code. This is now a thin adapter
...
public class ActionRunService {
  ...
  /** Runs {@code actionId} in {@code repoId}/{@code worktreeId} to completion. */
  public RunResult run(String repoId, String worktreeId, String actionId) {
    RunOutcome outcome = commandService.launchAndAwait(repoId, worktreeId, actionId);
