...
public class FeatureFlowPhaseActionService {
  ...
  @Transactional
  public FeatureFlowPhaseAction create(
      String stepId,
  ...
  public FeatureFlowPhaseAction get(String id) {
    return featureFlowPhaseActionRepository
        .findByIdOptional(id)
