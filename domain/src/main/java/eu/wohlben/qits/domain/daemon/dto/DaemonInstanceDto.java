 ...
 * /daemon/{worktreeId}/{daemonId}/}); its presence is the web-viewable flag (set iff the definition
 * declares an {@code httpPort}) — combine with a live {@code status} before framing it.
 */
