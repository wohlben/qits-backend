 ...
 * {@link DaemonEvent} and the {@code service:<name>} {@link CommandChunk} correlation carry).
 ...
 * Part 4.
 */
public record StartDaemon(String correlationId, String id, String script, Map<String, String> env)
