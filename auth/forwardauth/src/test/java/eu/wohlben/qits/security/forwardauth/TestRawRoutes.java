...
/**
 * Test stand-ins for the service app's raw Vert.x router routes (/git host, /service proxy):
 * /rawroute must be denied like any protected path — the regression proof that the global
