...
- `docs/epics/qits-project-repository-submodules/features/2026-07-14_workspace-submodule-support.md` — the **qits capability this prep depends
...
- `docs/epics/qits-testing-fixtures/features/2026-07-14_fixture-repos-history-purge.md` — the **parent** plan (fixtures-as-submodules +
...
- `docs/epics/qits-testing-fixtures/features/2026-07-05_servable-quarkus-angular-fixture.md` — created the Quarkus+Angular fixture
  and the current "bare repo committed as plain files + gitignored checkout" layout being replaced.
- `docs/epics/qits-testing-fixtures/features/2026-07-05_quarkus-angular-fixture-full-integration.md`,
  `docs/epics/qits-observability/features/2026-07-06_spa-observability.md`,
  `docs/epics/qits-observability/features/2026-07-11_spa-telemetry-meta-enrichment.md`,
  `docs/epics/qits-integration-angular/features/2026-07-14_capture-state-snapshot.md` — the SPA features that move **with** the SPA
  into the new `angular` repo. Their behaviour is untouched; only where the SPA lives changes.
- `docs/epics/qits-integration-angular/features/2026-07-13_qits-angular-integration-library.md` — the SPA depends on `@qits/angular`
...
- `docs/epics/qits-build-setup/features/2026-07-05_maven-build-cache.md` — the build-cache excludes and the per-module
  input-hashing must be reworked (see Touch points).
- `docs/epics/qits-workspaces/features/2026-07-04_workspace-containers.md`,
  `docs/epics/qits-workspaces/features/2026-07-08_lazy-workspace-container-provisioning.md` — the workspace-materialization
...
- ~~The parent plan's `git filter-repo` superproject-history purge + GitHub repo recreate.~~ **✅ Done
  2026-07-14** — `docs/epics/qits-testing-fixtures/features/2026-07-14_fixture-repos-history-purge.md`. Purged from `main`; old
