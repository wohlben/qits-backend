...
[health checks](../../qits-live-deployment/features/2026-05-01_health-checks.md), and the
[workspace containers](../../qits-workspaces/features/2026-07-04_workspace-containers.md) execution model.
...
`checkScript` can lean on it, and it demonstrates the [health-checks](../../qits-live-deployment/features/2026-05-01_health-checks.md)
