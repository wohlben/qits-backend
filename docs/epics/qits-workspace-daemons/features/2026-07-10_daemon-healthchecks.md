...
> workspace runs. They are unrelated to [health-checks](../../qits-live-deployment/features/2026-05-01_health-checks.md),
...
- **Runs through the container seam** ([workspace containers](../../qits-workspaces/features/2026-07-04_workspace-containers.md)).
...
- **Generalises the webview picker's web-view port**
  ([daemon-webview-picker](../../qits-workspace-detail/features/2026-07-05_daemon-webview-picker.md); the bare `httpPort`
...
- **Orthogonal to [observability](../../qits-observability/features/2026-07-04_observability.md).** OTEL exports the
...
- **Deferred hook for [feature-flows](../../qits-feature-flows/features/2026-05-01_feature-flows.md).** "Gate this phase
...
The [servable quarkus-angular fixture](../../qits-testing-fixtures/features/2026-07-05_servable-quarkus-angular-fixture.md)
...
- `Quarkus` → `COMMAND`: `curl -fsS -m 2 "http://127.0.0.1:8080${QITS_PUBLIC_BASE%/}/q/health"` —
  ...
  and the fixture has `smallrye-health` (see [health-checks](../../qits-live-deployment/features/2026-05-01_health-checks.md)).
