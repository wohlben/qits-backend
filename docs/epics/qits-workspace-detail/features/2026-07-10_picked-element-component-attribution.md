...
- `docs/epics/qits-workspace-detail/features/2026-07-05_daemon-webview-picker.md` — the picker this extends. The pick snippet
...
- `docs/epics/qits-workspaces/features/2026-07-04_container-file-access.md` + `2026-07-02_workspace-file-browser.md` —
...
- `docs/epics/qits-workspace-detail/features/2026-07-03_framework-aware-file-browser.md` — frontend framework detection stays
  frontend-side; the backend scanner runs unconditionally (an Angular scan of a non-Angular repo
  yields an empty map).
- `docs/epics/qits-coding-agents/features/2026-07-01_coding-agent-harness.md` — the consumer: the agent runs inside the
