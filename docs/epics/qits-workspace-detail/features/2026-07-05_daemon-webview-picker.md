...
Once [daemons](../../qits-workspace-daemons/features/2026-07-04_daemons.md) run the project's dev server, the rendered app is *right there* on a
...
- Hard dependency on [daemons](../../qits-workspace-daemons/features/2026-07-04_daemons.md): the thing being framed is a daemon instance (a
