...
Once [daemons](../../qits-workspace-services/features/2026-07-04_daemons.md) run the project's dev server, the rendered app is *right there* on a
...
- Hard dependency on [daemons](../../qits-workspace-services/features/2026-07-04_daemons.md): the thing being framed is a daemon instance (a
...
- The captured HTML feeds the agent through the same door the
  [coding-agent harness](../../qits-coding-agents/features/2026-07-01_coding-agent-harness.md) and
  [stream-json chat](../../qits-coding-agents/features/2026-07-01_stream-json-chat.md) already use: the
...
- Orthogonal to [observability](../../qits-observability/features/2026-07-04_observability.md), but the same shape of idea — qits obtaining a
...
- **Port collisions** — inherited limitation from the daemons feature; `httpPort` is hardcoded
  ...
  [workspace containers](../../qits-workspaces/features/2026-07-04_workspace-containers.md) — per-container network namespaces make the
