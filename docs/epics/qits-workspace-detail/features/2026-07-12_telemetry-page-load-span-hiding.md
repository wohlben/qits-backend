...
Builds directly on [SPA observability](../../qits-observability/features/2026-07-06_spa-observability.md) (which registered the
browser's `DocumentLoadInstrumentation`, the source of `resourceFetch`/`documentLoad`/`documentFetch`
spans) and [SPA telemetry meta-enrichment](../../qits-observability/features/2026-07-11_spa-telemetry-meta-enrichment.md) (which added
