...
- **Hard dependency on [actions](../../qits-feature-flows/features/2026-05-01_actions.md)** and the
  [command registry](../../qits-workspace-commands/features/2026-06-30_command-registry.md): the tab is a new *surface*
...
- **Reuses the [command audit logs](../../qits-workspace-commands/features/2026-06-30_command-audit-logs.md)** surface
  (`GET /commands`, `/commands/{id}/log`, terminate) for the run-history half of the tab, and
  the terminal socket / command pages from
  [command restore navigation](../../qits-workspace-commands/features/2026-06-30_command-restore-navigation.md) for
  interactive runs.
...
- **Adjacent to [feature-flows](../../qits-feature-flows/features/2026-05-01_feature-flows.md)**: phases bind global
...
> ([unified-action-scope](../../qits-feature-flows/features/2026-07-09_unified-action-scope.md)), and `seed-webapp`'s build/lint/test
...
[actions](../../qits-feature-flows/features/2026-05-01_actions.md); `ActionScope` is deliberately open to more tiers
