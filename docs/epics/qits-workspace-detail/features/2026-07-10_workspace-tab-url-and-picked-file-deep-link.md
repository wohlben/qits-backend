...
- `docs/epics/qits-workspace-detail/features/2026-07-10_picked-element-component-attribution.md` — produces the
...
- `docs/epics/qits-workspace-detail/features/2026-07-02_workspace-file-browser.md` +
...
- `docs/epics/qits-workspace-detail/features/2026-07-09_workspace-detail-tab-consolidation.md` / `…tab-regrouping.md` — the
