...
Related plans:
- Builds on the [coding-agent-harness](../../qits-coding-agents/features/2026-07-01_coding-agent-harness.md): the refinement
  is a one-shot `CodingAgent` run, and the builder gained a `.model(String)` flag.
- Ends in the [stream-json chat](../../qits-coding-agents/features/2026-07-01_stream-json-chat.md): the launched agent is the
