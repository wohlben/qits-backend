...
The piece that finally combines the [qits-artifactory](../../qits-artifactory/feature-ideas/qits-artifactory.md) and
...
- **Hard dependency (store side)** — [qits-artifactory](../../qits-artifactory/feature-ideas/qits-artifactory.md): uses the upload
