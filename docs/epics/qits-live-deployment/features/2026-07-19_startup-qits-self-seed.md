...
- **Submodule import semantics** —
  `docs/epics/qits-project-repository-submodules/features/2026-07-14_workspace-submodule-support.md`: creation-time import is one level;
...
- **Demo-seed relocation** — `docs/epics/qits-workspaces/features/2026-07-18_workspace-bootstrap-commands.md`: the
