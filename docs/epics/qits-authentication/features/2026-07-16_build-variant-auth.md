...
- `docs/epics/qits-workspaces/features/2026-07-04_workspace-containers.md`,
  `docs/epics/qits-workspaces/features/2026-07-08_lazy-workspace-container-provisioning.md` — why workspace containers
  call qits back over `/git`, `/api/otel`, `/mcp`; those callers cannot hold a user token, which is
  what shapes the public-path list.
- `docs/epics/qits-observability/features/2026-07-06_spa-observability.md`, `docs/epics/qits-feature-intake/features/2026-07-14_capture-ingest-workspace.md`
  — the cross-origin fixture-SPA traffic (`/api/otel/*` passthrough, `POST /api/capture`) that also
  stays token-free.
- `docs/epics/qits-coding-agents/features/2026-07-04_container-agent-sessions.md` — the Claude SessionStart hook that POSTs
...
- `docs/epics/qits-workspaces/features/2026-07-07_workspace-sse-live-updates.md` — the EventSource channel that motivated
  the oauth variant's cookie-session design (it cannot send an `Authorization` header).
- `docs/epics/qits-build-setup/features/2026-07-05_maven-build-cache.md` — the variant profiles change `service`'s
