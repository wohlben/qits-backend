...
- **Builds on [container-agent-sessions](2026-07-04_container-agent-sessions.md).**
  ...
  [devcontainer](../../qits-live-deployment/features/2026-07-07_qits-net-devcontainer-unification.md) mounts the same
  volume.
- **Stays on the agent path** ([unified action scope](../../qits-feature-flows/features/2026-07-09_unified-action-scope.md)
...
- **Runs through [workspace containers](../../qits-workspaces/features/2026-07-04_workspace-containers.md)** —
