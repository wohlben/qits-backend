...
The security payoff of [workspace containers](../../qits-workspaces/features/2026-07-04_workspace-containers.md) only fully lands
...
[configurable-git-identity](../../qits-workspaces/features/2026-07-09_configurable-git-identity.md)), so the mechanical relocation
...
- **Phase 1 — [workspace-containers](../../qits-workspaces/features/2026-07-04_workspace-containers.md)** (hard dependency): the
...
`qits.git.*` identity, see [configurable-git-identity](../../qits-workspaces/features/2026-07-09_configurable-git-identity.md)), so
