...
- Persistence rides the [command audit logs](../../qits-workspace-commands/features/2026-06-30_command-audit-logs.md)
...
- The [workspace chat dialog](../../qits-workspace-detail/features/2026-07-04_workspace-chat-dialog.md) depends on re-attach being lossless:
  its close/reopen cycle is a reconnect, so it inherits full restore for free once this lands.
- Complements [command restore navigation](../../qits-workspace-commands/features/2026-06-30_command-restore-navigation.md)
