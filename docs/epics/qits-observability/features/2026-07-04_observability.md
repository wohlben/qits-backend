...
- Agent access rides the MCP server from the
  [coding-agent harness](../../qits-coding-agents/features/2026-07-01_coding-agent-harness.md): the telemetry tools join the
...
- Resource attributes stamped at launch reuse the identity model of the
  [command registry](../../qits-workspace-commands/features/2026-06-30_command-registry.md) (workspace id, repository id, command id).
