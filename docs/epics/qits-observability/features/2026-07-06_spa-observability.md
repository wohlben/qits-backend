...
> now ships as the [`@qits/angular` library](https://github.com/wohlben/qits-angular-integration)
> ([qits-angular-integration-library](../../qits-integration-angular/features/2026-07-13_qits-angular-integration-library.md)); the
...
[workspace observation tabs](../../qits-workspace-detail/features/2026-07-06_workspace-observation-tabs.md) made the flowing
...
- **Followed by the [Quarkus/Angular integration guide](../../qits-integration-quarkus/features/2026-07-07_quarkus-angular-integration-guide.md)** —
