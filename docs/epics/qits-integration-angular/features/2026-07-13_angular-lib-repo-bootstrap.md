...
> **Status: executed.** This plan was written to be copied into the `wohlben/qits-angular-integration`
...
> `./dist/qits-angular-integration/types/qits-angular-integration.d.ts` (what ng-packagr actually writes — exactly why
