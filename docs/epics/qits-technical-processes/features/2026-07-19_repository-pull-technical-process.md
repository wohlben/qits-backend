...
- **Reuses the technical-process abstraction as designed** —
  `docs/epics/qits-technical-processes/features/2026-07-18_technical-process-log-stream.md` explicitly lists further instances
...
- **Instruments the recursive pull** — `docs/epics/qits-project-repository-submodules/features/2026-07-14_workspace-submodule-support.md`
...
- **Line delivery is post-hoc per git command**: `GitExecutor.exec` returns captured output;
  ...
  is spun out as
  [`streaming-gitexecutor-exec`](../../qits-project-repositories/features/2026-07-19_streaming-gitexecutor-exec.md) for very slow
...
- **Streaming `GitExecutor.exec`** —
  [`streaming-gitexecutor-exec`](../../qits-project-repositories/features/2026-07-19_streaming-gitexecutor-exec.md): live per-line
