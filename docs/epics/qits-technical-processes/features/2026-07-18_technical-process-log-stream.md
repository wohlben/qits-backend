...
- **Instruments the workspace start path** — `docs/epics/qits-workspaces/features/2026-07-08_lazy-workspace-container-provisioning.md`
  (the `ensureContainer`/`provisionContainer` flow this streams) and
  `docs/epics/qits-workspaces/features/2026-07-04_workspace-containers.md` (the `ContainerRuntime` seam that grew a
  streaming variant).
- **Correlates with the daemon lifecycle** — `docs/epics/qits-workspace-detail/features/2026-07-06_workspace-observation-tabs.md`
...
- **Adds a transient workspace-detail tab** — sibling in spirit to the parked
  ...
  persistence (`docs/epics/qits-workspace-detail/features/2026-07-09_draggable-workspace-detail-tabs.md`) via a new `zPinFirst`
  tab extension.
