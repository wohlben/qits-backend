...
- **Builds the deferred artifact storage** —
  `docs/features/2026-07-14_capture-ingest-workspace.md` stores the capture *only* as goal
...
- **Extends the capture payload and gesture** —
  `docs/features/2026-07-14_spa-feature-capture.md` defined `CapturePayload`, the freeze, and
...
- **Lands in the integration library** —
  `docs/features/2026-07-13_qits-angular-integration-library.md`: the rasterizer and rect
  stamping are library code (`qits-angular-integration`), rolled out SHA-pinned like every
  library change.
- **Sibling payload enrichment** — `docs/features/2026-07-14_capture-state-snapshot.md` added
