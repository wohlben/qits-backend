...
- **Lands in the goal text via** [capture-ingest-workspace](2026-07-14_capture-ingest-workspace.md) — the
...
[interaction telemetry convention](2026-07-11_spa-telemetry-meta-enrichment.md).
