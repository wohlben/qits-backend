...
- Modifies the `docker/workspace` image described in
  [workspace containers](2026-07-04_workspace-containers.md); the `.devcontainer/` that extends it
  (see [qits-net devcontainer unification](2026-07-07_qits-net-devcontainer-unification.md))
