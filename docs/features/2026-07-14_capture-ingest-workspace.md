...
- **Reuses the creation path of**
  [create-workspace-for-workspaceless-branch](2026-07-13_create-workspace-for-workspaceless-branch.md)'s
...
- **Sibling of the OTLP receiver**
  ([observability](2026-07-04_observability.md), `OtelReceiverResource` in
...
- **Lazy containers make this cheap**
  ([lazy provisioning](2026-07-08_lazy-workspace-container-provisioning.md)):
