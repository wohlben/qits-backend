...
- [workspace-actions-tab](2026-07-09_workspace-actions-tab.md) — the surface that exposed the
  mis-scoping; its effective-actions endpoint and scope badges are unchanged (same DTO wire
  shape).
- [servable-quarkus-angular-fixture](2026-07-05_servable-quarkus-angular-fixture.md) — the
...
- A **workspace tier** (`ActionScope.WORKSPACE`) remains deferred (see
  [workspace-actions-tab](2026-07-09_workspace-actions-tab.md)); it is now a nullable-FK/column
