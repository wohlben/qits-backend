...
- **Supersedes the dialog shell of
  ...
  [stream-json-chat](./2026-07-01_stream-json-chat.md)) carries over **for free**,
...
- **Modifies the frame of [daemon-webview-picker](./2026-07-05_daemon-webview-picker.md)**
  (and its [configuration follow-up](./2026-07-06_daemon-webview-configuration.md)) —
...
- Rides [workspace-sse-live-updates](./2026-07-07_workspace-sse-live-updates.md)
