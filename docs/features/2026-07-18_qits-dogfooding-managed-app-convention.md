...
([spa-observability](2026-07-06_spa-observability.md)): a `GET /api/config.json` identity relay, a
`POST /api/otel/v1/*` OTLP path, and the browser-side
[`@qits/angular` library](2026-07-13_qits-angular-integration-library.md), with the
[`testing-repo-quarkus-angular` fixture](2026-07-05_servable-quarkus-angular-fixture.md) as the
...
Related/dependent plans: [daemons](2026-07-04_daemons.md) ·
[daemon web-view configuration](2026-07-06_daemon-webview-configuration.md) ·
[observability](2026-07-04_observability.md) (the in-process OTLP receiver this feature tees) ·
[spa-feature-capture](2026-07-14_spa-feature-capture.md) ·
[capture-state-snapshot](2026-07-14_capture-state-snapshot.md) ·
[build-variant auth](2026-07-16_build-variant-auth.md) (PublicPaths/QitsAuthPolicy touched) ·
[workspace submodule support](2026-07-14_workspace-submodule-support.md) (building qits in a
