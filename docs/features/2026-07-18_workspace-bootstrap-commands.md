...
data not seeded, nothing built. Daemons ([auto-start](./2026-07-09_daemon-autostart-on-workspace-start.md))
...
- **Sibling of [daemon auto-start](./2026-07-09_daemon-autostart-on-workspace-start.md)** —
...
- **Executes through the action/command machinery** ([actions](./2026-05-01_actions.md),
  [command registry](./2026-06-30_command-registry.md),
  [command audit logs](./2026-06-30_command-audit-logs.md)) — a bootstrap command runs
...
- **Extends [.qits-config in-repo configuration](./2026-07-18_qits-config-in-repo-configuration.md)** —
  a new `bootstrap:` section, reconciled by `QitsConfigReconciler` with the same `@qits-config`
  namespacing; and the [dogfooding convention](./2026-07-18_qits-dogfooding-managed-app-convention.md)
...
- **Completes the [disposable-containers](./2026-07-04_disposable-workspace-containers.md)
  ...
  *bootstrap state* (deps, build output, demo data), so prune-and-recreate finally round-trips
  everything.
- **Streams through the [technical-process log stream](./2026-07-18_technical-process-log-stream.md)** —
...
- **Workspace detail**: a Bootstrap tab à la the Daemons tab — the configured commands in order,
  ...
  Start process (see the [technical-process log stream](./2026-07-18_technical-process-log-stream.md)).
