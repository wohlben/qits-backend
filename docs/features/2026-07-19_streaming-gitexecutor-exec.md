...
The [streamed repository pull](../features/2026-07-19_repository-pull-technical-process.md) delivers
...
- **Copies the container-side precedent** — `ContainerRuntime.exec(..., Consumer<String> onLine, …)`
  ...
  [technical-process log stream](../features/2026-07-18_technical-process-log-stream.md), which
