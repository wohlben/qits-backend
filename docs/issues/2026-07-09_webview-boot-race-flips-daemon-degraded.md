...
[daemons](../epics/qits-workspace-services/features/2026-07-04_daemons.md) observer pipeline (`LogLevelClassifier`,
...
ERROR-classified) trigger. The [daemon-healthchecks idea](../epics/qits-workspace-services/features/2026-07-10_daemon-healthchecks.md)'s
