...
- `docs/epics/qits-coding-agents/features/2026-07-04_container-agent-sessions.md` — the shared-credential-volume login model.
- `docs/epics/qits-workspaces/features/2026-07-04_workspace-containers.md` — the per-workspace container execution model (the login terminal is one such container command).
- `docs/epics/qits-coding-agents/features/2026-07-01_coding-agent-harness.md` — the coding-agent code path that triggers the login redirect.
