...
[tmux-backed daemons Increment 2](../../epics/qits-workspace-services/features/2026-07-05_tmux-backed-daemons.md) (the interactive
terminal). Unrelated to that feature — this is a pre-existing defect in the daemon **Start/Stop**
control buttons. Related: [daemons](../../epics/qits-workspace-services/features/2026-07-04_daemons.md).
