...
The repository detail page renders the **branch tree**: all branches as a forest, each nested under the parent it was forked from, with workspace-backed branches marked. Per branch/workspace the tree surfaces:
...
- `repositories-repoId-workspaces` — the in-flight workspaces
- `repositories-repoId-workspaces-workspaceId-incoming-commits` — commits the parent has that the change lacks
