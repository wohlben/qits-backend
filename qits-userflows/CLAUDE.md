...
- **No product stories here.** Real qits user stories live in the sibling
  [`userflows`](../userflows/CLAUDE.md) module, organized by domain (`…userflows.project`,
...
- Authoring conventions (how to write a story, the `Flow` API, dependent flows, running) are
  documented where the stories live — see [`userflows/CLAUDE.md`](../userflows/CLAUDE.md) and the
